                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        Creamy Friends are the 2nd Generation of NFTs from CryptoCream Studios.
                                                        They will reward holders with a staking platform,
                                                        a casino game, Metaverse integration and an upcoming on-chain game on Solana.
                                                        In addition to the utilities listed above,
                                                        each one of our holders will have access to our existing premium discord services.
                                                        We have a vast team of analysts that provide NFT alpha,
                                                        trading signals, crypto futures calls alongside live/recorded classes.
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (5166/5555)
                          </span>
                        </div>
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                          href="https://creamyfriends.com/#About"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                        ...
                        <a
                                                                href="https://discord.com/invite/creamyfriends"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                STAKING DAY-1
                                                                $CREAMY, our own utility-token will be ready to thrive within
                                                                $Solana ecosystem and become your new source of passive income from Day-1.

                                                                CREAMY CASINO
                                                                Our staking pool will be powered by a decentralized casino with 80% of the proceeds.
                                                                This will maintain the health of the token for the years to come.

                                                                ON-CHAIN GAME
                                                                We are planning to launch an on-chain game for holders only,
                                                                to compete to earn the secondary market royalties of the month.
                                                                Be ready to compete with your friends and earn.
                        </p>
                      </div>
                    </div>
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Staking released day one!

                                                                        Dao is created. NFT holders will be able to verify ownership. Holders will be given access to the CC DAO.

                                                                        Holders unlock access to the private discord channels

                                                                        Metaverse demo released.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Public launch of our first of many games on our online casino.
                                                                        Proceeds will be used to maintain liquidity for $CREAMY which will be used to pay
                                                                        holders that are staking their Genesis and Creamy Friends NFTs.

                                                                        Creamy Friends enter the Metaverse! Holders will be able to roam the digital
                                                                        world as features will be continuously added such as properties,
                                                                        parties and more as the community grows. (this will be shown in the metaverse demo)

                                                                        On-chain game demo is published.
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Our On-Chain game is launched. We will be continuously updating
                                                                        the game adding a variety of enemies, levels, boss battles and much more
                                                                        which can be suggested by the holders.

                                                                        Monthly competitions begin. Winners will receive a percentage of
                                                                        secondary market royalties earned within that month.
                            </p>
                            <br />
                          </div>
